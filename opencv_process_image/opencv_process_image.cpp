...
int main()
{
    ...
    imwrite(path_out + "2-adaptiveThreshold.jpg", bw);
    ...
    imwrite(path_out + "3-horizontal.jpg", horizontal);
    ...
    imwrite(path_out + "4-vertical.jpg", vertical);
    ...
    //
    //imwrite(path_out + "5-joints.jpg", joints);
